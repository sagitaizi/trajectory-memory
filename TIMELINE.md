...
Today: **2026-09-09**. Camera leaves **2026-09-10** (Sagi away ~1 month, laptop only, returns
2026-10-10).
...
| Sep 10–13 | Framework research (G-F) — decide reservoir vs snnTorch for the memory core | ⬜ |
| Sep 14–20 | `frontend.frames`; provisional model + `baseline.py`; pretrain on sim | ⬜ |
